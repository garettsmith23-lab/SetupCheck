        ...
        {data && (
          <div>
            ...
            <div style={{ textAlign: 'center', marginTop: 14 }}>
              <button onClick={() => { setData(null); setSym(''); }} style={{ padding: '7px 18px', fontSize: 12, background: 'transparent', border: '1px solid #ddd', borderRadius: 6, cursor: 'pointer', color: '#666' }}>Analyze another</button>
            </div>
          </div>
        )}
